...
// ----------------------------------------------------------------
// note:  you'll get server not reachable if you don't have the right
//        username/password (appId, masterKey)
//
//        I'm not sure we should be initializing like this or
//        just to use config
// ----------------------------------------------------------------
/** 
...
app.use(mountPath, new ParseServer(config.server));
